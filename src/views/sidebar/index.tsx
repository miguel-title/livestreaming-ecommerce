    ...
    <>
      ...
      <SideBarWrapper>
        ...
        <SideBarContent>
          ...
          <Link to="/configurepayment" data-tip data-for="configurepayment">
            <MenuItem>
              <BsCardChecklist />
            </MenuItem>
          </Link>
          ...
          <Link to="/productcatalog" data-tip data-for="productcatalog">
            <MenuItem>
              <AiOutlineDropbox />
            </MenuItem>
          </Link>
          ...
          <Link to="/editaccount" data-tip data-for="user">
            <MenuItem>
              <FiUser />
            </MenuItem>
          </Link>
